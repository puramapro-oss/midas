...
// Extracted from technical-agent.ts to reduce file size
// 15 pure scoring functions: RSI, MACD, Bollinger, EMA, Stochastic, ADX, OBV,
// CCI, Williams %R, MFI, StochRSI, Force Index, Elder Ray, Volume Profile
// =============================================================================
