...
import { BINANCE_REFERRAL, STEPS } from './binance-connection-steps';
...
export default function ConnectBinancePage() {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setConnected(true);
        toast.success('Binance connecté avec succès');
      } else {
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-[var(--text-secondary)] mt-1">
          Suis ces 8 étapes pour connecter ton compte Binance à MIDAS
        </p>
      </div>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-[#FFD700]/5 flex items-center justify-center">
                  <span className="text-lg font-bold text-[#FFD700]">{currentStep + 1}</span>
                </div>
              ...
              {isLastStep && !connected && (
                <div className="space-y-3 pt-2">
                  <div>
                    <label className="text-xs text-white/40 uppercase tracking-wider mb-1.5 block">Clé API</label>
                    <input
                      type="text"
                      value={apiKey}
                  ...
                  <div>
                    <label className="text-xs text-white/40 uppercase tracking-wider mb-1.5 block">Clé secrète</label>
                  ...
                  <div className="flex items-start gap-2 text-xs text-white/30">
                    ...
                    <span>Tes clés sont chiffrées AES-256 avant stockage. Personne ne peut les voir, même pas nous.</span>
                  </div>
              ...
              {connected && (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-emerald-400">Binance connecté !</h3>
                  <p className="text-sm text-[var(--text-secondary)]">
                    MIDAS est prêt à analyser et trader pour toi.
                  </p>
                  <Link
                    href="/dashboard"
