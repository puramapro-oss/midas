...
import { PAIRS, TIMEFRAMES, SAMPLE_AGENTS, signalColors, type AgentVote } from '@/lib/trading/constants'
import { fetchRealCandles, formatPrice, type CandleData } from '@/lib/trading/utils'
